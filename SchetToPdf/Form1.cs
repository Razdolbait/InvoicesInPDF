...
namespace SchetToPdf
{
    public partial class Form1 : Form
    {
        ...
        {
            InitializeComponent();
            textBox1.Text = "Программа предназначена для преобразования счетов из формата TXT в  PDF" + '\r' + '\n' +
                '\r' + '\n' + 
                "Конвертирует все файлы в выбранной папке в алфавитном порядке. " + '\r' + '\n' +
                "Группирует счета по УНП. "+ '\r' + '\n' +
                "Ориентация страницы меняется по последнему символу в имени файла. " + '\r' + '\n' +
                "Если последний символ _ (подчеркивание) счет будет в альбомной ориентации. " + '\r' + '\n' +
                "Например: voda.txt - книжная, voda_.txt - альбомная." + '\r' + '\n' +
                '\r' + '\n' +
                "Счета в формате PDF сохраняются в исходную папку. Имя файла - УНП.";
        }
